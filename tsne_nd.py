...
from kclusterer import plot_tsne
...
if __name__ == '__main__':
    dats = main()
    fili = open('tsne_searlesmono1_p'+str(perplexity)+'i'+str(tsne_iter)+'.pkl','wb')
    pickle.dump(dats,fili)
    fili.close()

#plot_tsne(dats,'tsne_searlesmono_p'+str(perplexity)+'i'+str(tsne_iter)+'.png',test=False,savek=False)
